...
import com.yh.qyweixin.sdk.cache.IAccessTokenCache;
import com.yh.qyweixin.sdk.kit.ParaMap;
import com.yh.qyweixin.sdk.utils.RetryUtils;
...
public class AccessTokenApi {
    ...
    public static AccessToken refreshAccessToken(ApiConfig ac) {
        ...
        final Map<String, Object> queryParas = ParaMap.create("corpid", corpid).put("corpsecret", corpsecret).getData();
