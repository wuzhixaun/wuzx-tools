package com.wuzx.weixin.qyweixin.sdk.api.media;

import cn.hutool.http.HttpRequest;
import cn.hutool.json.JSONUtil;
import com.yh.qyweixin.sdk.api.AccessTokenApi;
import com.yh.qyweixin.sdk.api.ApiResult;
import com.yh.qyweixin.sdk.utils.HttpUtils;
...
public class MediaApi {
	...
	public static ApiResult addNews(MediaMpNews mediaMpNews) {
		...
		final String jsonResult = HttpRequest.post(url).body(JSONUtil.toJsonStr(mediaMpNews)).execute().body();
	...
	public static ApiResult delMaterial(String media_id,String agentid) {
		...
		final String jsonResult = HttpRequest.get(url).execute().body();
		return new ApiResult(jsonResult);
	}
	...
	public static ApiResult updateNews(MediaMpNews mediaMpNews) {
		...
		String jsonResult = HttpRequest.post(url).body(JSONUtil.toJsonStr(mediaMpNews)).execute().body();
		return new ApiResult(jsonResult);
	}
	...
	public static ApiResult getMaterialCount(String agentid) {
		...
		String jsonResult = HttpRequest.get(url).execute().body();
		return new ApiResult(jsonResult);
	}
	...
	public static ApiResult batchGetMaterial(MediaType mediaType, int offset, int count,int agentid) {
		...
		String jsonResult = HttpRequest.post(url).body(JSONUtil.toJsonStr(dataMap)).execute().body();
